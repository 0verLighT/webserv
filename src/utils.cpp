...
bool	isFloat(const std::string& valueString) {
  ...
  if (valueString == "inf" || valueString == "+inf" || valueString == "-inf" ||
    valueString == "nan" || valueString == "+nan" || valueString == "-nan")
    return (true);
...
bool	isBase(const std::string& valueString) {
  return (startsWith(valueString, "0b") || startsWith(valueString, "0o") || startsWith(valueString, "0x"));
}
...
float	toFloat(const std::string& valueString) {
  if (valueString == "inf" || valueString == "+inf")
    return (std::numeric_limits<float>::infinity());
  if (valueString == "-inf")
    return (-std::numeric_limits<float>::infinity());
  if (valueString == "nan" || valueString == "+nan" || valueString == "-nan")
